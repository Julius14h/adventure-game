...
public class Room implements Serializable {
    ...
    public String getObjectString() {
        ...
        for (AdventureObject object: objectsInRoom){ // get all the descriptions and add it to the list
            String description = object.getDescription();
            // ensure there is no duplicate directions
            if (!objects.contains(description)) {
    ...
    public String getCommands() {
        ...
        for (Passage passage: getMotionTable().passageTable){ // get all the directions and add it to the list
